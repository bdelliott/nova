...
class ComputeManager(manager.SchedulerDependentManager):
    ...
    def _run_instance(self, context, request_spec,
        ...
        try:
            ...
            notify("end")  # notify about successful build

        except exception.BuildAbortException as e:
            # Instance build encountered an error, but the instance
            # should not go to error.
            LOG.debug(e.message)
            notify("error")  # notify that something went wrong
