...
class ComputeTestCase(BaseTestCase):
    ...
    def test_run_instance_error_notification_on_abort(self):
        # Test that error notif is sent if build is aborted
        instance = jsonutils.to_primitive(self._create_fake_instance())
        instance_uuid = instance['uuid']

        def build_inst_abort(*args, **kwargs):
            raise exception.BuildAbortException(reason="aborted",
